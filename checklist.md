...
* [x] Open `cartels.html` that was saved previously.
...
* [x] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID5ed3dedbd0102), select SR time period, upload `cartels-sr.zip`
...
* [x] Add **anonymized** files to git, e.g. `cartels-smoothread01.txt`
...
* [x] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID5ed3dedbd0102))

...
./make_project.py
```
* [x] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID5ed3dedbd0102#project-comments)
* [x] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=70267) and read all posts
* [x] Open `cartels-utf8.txt` in Guiguts
...
* [x] [En dash](https://www.pgdp.net/wiki/En-dash):
  ...
  * **Do not** change dash in fractions like `1-1/2` (or Convert Fractions function will be confused)
...
* [x] Use `File → Save a Copy As` to make `cartels.html`
...
* [x] Re-open `cartels-utf8.txt` (if not still open).
...
* [ ] Search `[^A-Z][A-Z]\.\n[A-Z]\.` to look for initials across a line-break and rewrap as appropriate.
...
* [ ] Open `cartels.html` that was saved previously.
...
* [ ] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID5ed3dedbd0102), select SR time period, upload `cartels-sr.zip`
...
* [ ] Add **anonymized** files to git, e.g. `cartels-smoothread01.txt`
...
* [ ] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID5ed3dedbd0102))
...
* [ ] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID5ed3dedbd0102)
